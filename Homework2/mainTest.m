...
while ~feof(fidInput)
	...
	data=[x; y];
	output(id, :)=circleFitByDss(data); id=id+1;	% You can comment out this line (and uncomment the next line) to test circleFitByDssSP.p
%	output(id, :)=circleFitByDssSP(data); id=id+1;
end
fclose(fidInput);
